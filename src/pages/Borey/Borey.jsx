...
const boreysForSale = [
    ...
    { id: 3, name: 'Le Conde BKK1', price: 'Price from: $85,000', location: 'BKK 1, Boeng Keng Kang, Phnom Penh', img: 'https://luxrealty.asia/wp-content/uploads/2024/06/Sky-Villa-3.jpg' },
...
const boreysForRent = [
    { id: 6, name: 'J Tower 2 Boreyminium', price: 'Price from: $183,645', location: 'BKK 1, Boeng Keng Kang, Phnom Penh', img: 'https://pix10.agoda.net/hotelImages/18942490/0/701c37817bdde998c1b0893a1144b06d.jpeg?ce=0&s=702x392' },
...
export default function Borey() {
    const [activeTab, setActiveTab] = useState('Buy');

    return (
        <div className="borey-page">

            {/* ── Hero Section ── */}
            <div className="borey-hero">
                <div className="borey-hero-overlay"></div>
                <div className="borey-hero-layout">

                    {/* Center: Search Box */}
                    <div className="borey-center">
                        <div className="borey-hero-search">
                            <h2>Find Boreys in Cambodia</h2>
                            <div className="borey-search-tabs">
                            ...
                            <div className="borey-search-input">
                                <MenuIcon />
            ...
            {/* ── Listings Below Hero ── */}
            <div className="borey-listings-page">

                {/* Completed Boreys for Sale */}
                <section className="borey-section">
                    <div className="borey-section-header">
                        <div>
                            <h2 className="borey-section-title">Completed Boreys for Sale</h2>
                        </div>
                        <span className="borey-section-count">{boreysForSale.length} Properties</span>
                    </div>
                    <div className="borey-grid">
                        {boreysForSale.map(c => (
                            <Link to={`/property/${c.id}`} key={c.id} className="borey-card">
                                <div className="borey-card-img-wrap">
                                    <img src={c.img} alt={c.name} />
                                    <span className="borey-video-badge">&#9654; VIDEO</span>
                                </div>
                                <div className="borey-card-info">
                                    <h4>{c.name}</h4>
                                    <p className="borey-card-price">{c.price}</p>
                                    <p className="borey-card-loc">{c.location}</p>
                                </div>
                            </Link>
                        ))}
                    </div>
                    <div className="borey-view-more-wrap">
                        <button className="borey-view-more-btn">View More</button>
                    </div>
                </section>

                {/* Completed Boreys for Rent */}
                <section className="borey-section">
                    <div className="borey-section-header">
                        <div>
                            <h2 className="borey-section-title">Completed Boreys for Rent</h2>
                        </div>
                        <span className="borey-section-count">{boreysForRent.length} Properties</span>
                    </div>
                    <div className="borey-grid">
                        {boreysForRent.map(c => (
                            <Link to={`/property/${c.id}`} key={c.id} className="borey-card">
                ...
                <section className="borey-section">
                    <div className="borey-section-header">
                        <div>
                            <h2 className="borey-section-title">News &amp; Guides</h2>
                        </div>
                    </div>

                    <div className="borey-news-layout">
                        {/* Featured promo */}
                        <div className="borey-news-featured">
                            <img
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBoaXEIxnEdc6Gy7zMY7TO19o5NhCoW-9EXkHW4mmq4xEBI3NAn3kMdkM&s=10"
                                alt="Time Square 9"
                                className="borey-news-featured-img"
                            />
                            <div className="borey-news-featured-overlay">
                                <div className="borey-news-featured-badge">FEATURED</div>
                                <h3>Time Square 9 — The Gatsby Residence</h3>
                                <p>BKK1 Prime Location · Starting from <strong>$1,700/sqm</strong></p>
                                <button className="borey-news-featured-btn">Secure Pre-Sale Deal</button>
                            </div>
                        </div>

                        {/* Articles list */}
                        <div className="borey-news-articles">
                            {[
                                {
                                    title: 'Cambodia Allows Latin Alphabet Names on Borey Titles for Foreign Property Owners',
                                ...
                                },
                                {
                                    ...
                                    excerpt: 'You bought a property, let say a house or borey. 2 important questions: What if the seller doesn\'t...',
                                    img: 'https://www.boreyphnompenhthmey.com/assets/images/borey/2017-12-26__11-16-32__Villa.jpg',
                                },
                                {
                                ...
                                <div key={i} className="borey-news-article">
                                    <img src={article.img} alt={article.title} className="borey-news-thumb" />
                                    <div className="borey-news-article-body">
                                        <h4 className="borey-news-article-title">{article.title}</h4>
                                        <p className="borey-news-article-date">{article.date}</p>
                                        <p className="borey-news-article-excerpt">{article.excerpt}</p>
                                    </div>
                                </div>
                            ))}
                ...
                <section className="borey-section">
                    <div className="borey-section-header">
                        <div>
                            <h2 className="borey-section-title">Featured Developers</h2>
                        </div>
                    </div>
                    <div className="borey-grid">
                        {[
                            ...
                            <Link to="#" key={i} className="borey-card dev-card">
                                ...
                                <div className="borey-card-info">
                                    <h4>{dev.name}</h4>
                                    <p className="borey-card-loc">{dev.desc}</p>
                                </div>
                            </Link>
                        ))}
                    </div>
                ...
                <section className="borey-section">
                    <div className="borey-section-header">
                        <div>
                            <h2 className="borey-section-title">Popular Locations</h2>
                        </div>
                    </div>
                    <div className="borey-grid">
                        {[
                            ...
                            <Link to="#" key={i} className="borey-location-card">
