...
export default function DounPenh() {
    return (
        <div className="doun-penh-page">
            {/* Top Filter Bar */}
                ...
                <div className="top-filter-bar">
                    <div className="filter-group">
                        ...
                        <div className="filter-box search-loc-box">
                            <MenuIcon />
                            <input type="text" value="DounPenh" readOnly />
                        </div>
            ...
            <div className="main-container">
                ...
                <div className="page-header">
                    <div className="header-title-row">
                        <h1>Real Estate for Sale in Doun Penh</h1>
                    ...
                    <div className="header-meta-row">
                        <span className="results-count">Found 1,842 residential properties for sale in Doun Penh</span>
