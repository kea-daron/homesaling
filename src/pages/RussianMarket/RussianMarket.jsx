...
export default function RussianMarket() {
    return (
        <div className="russian-market-page">
            {/* Top Filter Bar */}
                ...
                <div className="top-filter-bar">
                    <div className="filter-group">
                        ...
                        <div className="filter-box search-loc-box">
                            <MenuIcon />
                            <input type="text" value="RussianMarket" readOnly />
                        </div>
            ...
            <div className="main-container">
                ...
                <div className="page-header">
                    <div className="header-title-row">
                        <h1>Real Estate for Sale in Russian Market</h1>
                    ...
                    <div className="header-meta-row">
                        <span className="results-count">Found 5,234 residential properties for sale in Russian Market</span>
