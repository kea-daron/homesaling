...
export default function Sihanoukville() {
    return (
        <div className="sihanoukville-page">
            {/* Top Filter Bar */}
                ...
                <div className="top-filter-bar">
                    <div className="filter-group">
                        ...
                        <div className="filter-box search-loc-box">
                            <MenuIcon />
                            <input type="text" value="Sihanoukville" readOnly />
                        </div>
            ...
            <div className="main-container">
                ...
                <div className="page-header">
                    <div className="header-title-row">
                        <h1>Real Estate for Sale in Sihanoukville</h1>
                    ...
                    <div className="header-meta-row">
                        <span className="results-count">Found 5,234 residential properties for sale in Sihanoukville</span>
